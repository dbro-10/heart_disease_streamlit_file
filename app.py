...
Original file is located at
    https://colab.research.google.com/drive/1Ce2UwTdiZCz1KPrAClxIu2CZqMY9MgmV
"""
...
st.markdown("### Built by [Your Name] – AI & Data Science Apprentice Applicant")
st.markdown("Using Random Forest trained on the UCI Heart Disease dataset")

# ------------------- Load Model -------------------
@st.cache_resource
def load_model():
    # The model is saved in the same repo
...
if st.button("Predict Risk of Heart Disease", type="primary"):
    ...
    if prediction == 1:
        ...
        st.warning("Patient likely has heart disease. Recommend immediate clinical review.")
    else:
